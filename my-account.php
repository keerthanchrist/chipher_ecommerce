...
<html lang="en">
	<head>
	    ...
	    <title>Cipher Kart | Account</title>
...
<div class="form-group">
					    ...
					    <input type="text" class="form-control unicase-form-control text-input" value="<?php echo $row['name'];?>" id="name" name="name" required="required"  readonly>
					  </div>
